...
public class CustomberListAdapter extends RecyclerView.Adapter<CustomberListAdapter.Holder> {

    private LayoutInflater mLayoutInflater;
    public List<CustomberListData> dataList = new ArrayList<>();
    String image_url = "";

    public CustomberListAdapter(LayoutInflater mLayoutInflater) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.help_line_layout, parent, false);
    ...
    public void addData(List<CustomberListData> dataList, String image_url) {
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public void bind(@NonNull CustomberListData resultsBean) {
            ...
            txtProvider.setText(resultsBean.getCustomer_care_number());
            txtNumber.setText(resultsBean.getName());
